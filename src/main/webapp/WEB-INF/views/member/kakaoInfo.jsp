...
<div align="center">
   ...
   <caption><font size="5">${kakaoInfo.email } 회원정보</font></caption>
   <tr><th>아이디</th><td>${kakaoInfo.id }</td></tr>
   <tr><th>이메일</th><td>${kakaoInfo.email }</td></tr>
   <tr><th>주소</th><td>${kakaoInfo.addr }</td></tr>
    </table>
</div>
